class Ballgame {
    ...
    move() {
        ...
        */
        ...
        var hitBar = hitTestside(this.img, bar);
        console.log(hitBar);

        if (hitBar == "top" || hitBar == "bottom") {
            this.velY = -1 * this.velY;

        }

        if (hitBar == "left" || hitBar == "right") {
            this.velX = -1 * this.velX;
        ...
        for (var i = 0; i < 4; i++) {
            ...
            hitblock[i] = hitTestside(this.img, block[i]);

            if (hitblock[i] == "top" || hitblock[i] == "bottom") {
                this.velY = -1 * this.velY;
            ...
            if (hitblock[i] == "left" || hitblock[i] == "right") {
                this.velX = -1 * this.velX;
                block[i].style.opacity -= 0.5;
